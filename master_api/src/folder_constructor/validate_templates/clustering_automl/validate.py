...
def validate(
    ...
    """Cluster X_test using selected features and compute silhouette score.

    For now this mirrors the classic clustering baseline, but lives in a
    separate template so we can plug in AutoML-style preprocessing later.
    """
