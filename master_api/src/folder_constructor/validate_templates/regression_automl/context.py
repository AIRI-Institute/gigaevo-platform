...
def build_context(
    ...
    """
    Build a standard regression context for feature selection tasks.
    Compatible with both classic and AutoML-based validation.
    """
    ...
    y_series = df[TARGET_COLUMN].astype("float32")
